...
int TransferTransReqProcessor::process(std::unique_ptr<Msg>&& msg){
    ...
    lamport_client_ptr->replys_[lamport_client_ptr->client_id_ - 1] = true; // Current server is true
    ...
    lamport_client_ptr->finishes_[lamport_client_ptr->client_id_ - 1] = true; // Current server is true
